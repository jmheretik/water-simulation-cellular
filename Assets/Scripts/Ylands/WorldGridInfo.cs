...
namespace TerrainEngine
{
	...
	public static class WorldGridInfo
	{
		...
		/// </summary>
		public const int kVoxelsPerChunk = 16;
		public const int kVoxelsPerChunkLog2 = 4;

		/// <summary>
		/// Size of block in chunks.
		/// </summary>
		// TODO 8 and 3 in ylands
		...
		{
			public const double kVoxelSize = 0.75;
		...
		/// <summary>
		/// Converts from voxel units to meters
		/// </summary>
		public const float VxToMt = kVoxelSize;

		/// <summary>
		/// Converts from meters to voxel units.
		/// </summary>
		public const float MtToVx = (float) (1 / HighPrecision.kVoxelSize);
		...
		public static VectorI3 GetVoxelsPerChunkV3()
		{ 
			return new VectorI3(kVoxelsPerChunk, kVoxelsPerChunk, kVoxelsPerChunk);
		}

		public static VectorI3 GetChunksPerBlockV3()
		{
			return new VectorI3(kChunksPerBlock, kChunksPerBlock, kChunksPerBlock);
		}

		public static VectorI3 GetVoxelsPerBlockV3()
		{
			return new VectorI3(kVoxelsPerBlock, kVoxelsPerBlock, kVoxelsPerBlock);
		}

		public static Vector3 GetBlockSizeV3()
		{
			return new Vector3(kBlockSize, kBlockSize, kBlockSize);
		}

		public static Vector3 GetChunkSizeV3()
		{
			return new Vector3(kChunkSize, kChunkSize, kChunkSize);
		}
		...
		/// </summary>
		public static VectorI3 WorldToBlock(Vector3 worldPosition)
		{
		...
		/// </summary>
		public static VectorI3 WorldToVoxel(Vector3 worldPosition)
		{
		...
		/// </summary>
		public static VectorI3 BlockVoxelToBlockChunk(int vx, int vy, int vz)
		{ 
			return new VectorI3(vx >> kVoxelsPerChunkLog2, vy >> kVoxelsPerChunkLog2, vz >> kVoxelsPerChunkLog2);
		}

		/// <summary>
		/// Chunk-local voxel coordinates from block-local voxel coordinates.
		/// </summary>
		public static VectorI3 BlockVoxelToChunkVoxel(int vx, int vy, int vz)
		{ 
			return new VectorI3(vx & (kVoxelsPerChunk - 1), vy & (kVoxelsPerChunk - 1), vz & (kVoxelsPerChunk - 1));
		}
		...
		/// </summary>
		public static VectorI3 VoxelIdToChunkVoxel(int voxelId)
		{
			return new VectorI3((voxelId >> kVoxelsPerChunkLog2 * 2) & (kVoxelsPerChunk - 1), (voxelId >> kVoxelsPerChunkLog2) & (kVoxelsPerChunk - 1), voxelId & (kVoxelsPerChunk - 1));
		}
		...
		/// </remarks>
		public static VectorI3 ClampBlockSubVoxel(VectorI3 block, ref int vx, ref int vy, ref int vz)
		{
			while (vx < 0)
			{
